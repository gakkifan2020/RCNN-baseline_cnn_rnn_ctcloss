...
def test(net, data, abc, cuda, batch_size=20):
...
train_json = json.load(open('../tianchi_data/mchar_train.json'))
train_label = [train_json[x]['label'] for x in train_json.keys()]
train_path = ['../tianchi_data/mchar_train/' + x for x in train_json.keys()]

val_json = json.load(open('../tianchi_data/mchar_val.json'))
val_label = [val_json[x]['label'] for x in val_json.keys()]
val_path = ['../tianchi_data/mchar_val/' + x for x in val_json.keys()]
